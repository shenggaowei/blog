<template>
  ...
  <p>
    <img
      src="https://shenggao.oss-cn-beijing.aliyuncs.com/blog/2020/10/data"
      alt=""
    />
  </p>
  ...
  <p>
    <img
      src="https://shenggao.oss-cn-beijing.aliyuncs.com/blog/2020/09/stack.png"
      alt="stack"
    />
  </p>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token function">bar</span><span class="token punctuation">(</span><span class="token number">7</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  ...
  <p>
    <img
      src="https://shenggao.oss-cn-beijing.aliyuncs.com/blog/2020/09/stackcall.png"
      alt=""
    />
  </p>
...
<span class="token punctuation">}</span>
  ...
  <p>
    <img
      src="https://shenggao.oss-cn-beijing.aliyuncs.com/blog/2020/09/stackCall.jpg"
      alt=""
    />
  </p>
  <p>
  ...
  <p>
    <img
      src="https://shenggao.oss-cn-beijing.aliyuncs.com/blog/2020/09/queue.png"
      alt=""
    />
  </p>
  ...
  <p>
    <img
      src="https://shenggao.oss-cn-beijing.aliyuncs.com/blog/2020/10/eventloop.png"
      alt=""
    />
  </p>
  <p>例子代码：</p>
...
<span class="token comment">// timer 1 over</span>
  ...
  <p>
    <img
      src="https://shenggao.oss-cn-beijing.aliyuncs.com/blog/2020/10/执行队列.png"
      alt=""
    />
  </p>
...
<span class="token comment">// timer over</span>
  ...
  <p>
    <img
      src="https://shenggao.oss-cn-beijing.aliyuncs.com/blog/2020/10/task.png"
      alt=""
    />
  </p>
