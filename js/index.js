/**
 * Created by ShengGao on 2017/1/31.
 */
...
document.addEventListener(
  ...
  function () {
    ...
    document.addEventListener("scroll", function () {
      ...
      document
        .getElementById("J_header")
        .setAttribute(
          "class",
          delta > 0 && afterScrollTop > 0
    ...
    isShowQr &&
      loadScript(
        "https://gw.alipayobjects.com/os/k/qa/qrcode.min.js",
        function () {
          QRCode &&
    ...
    zoomImgs &&
      zoomImgs.length > 0 &&
      loadScript(
        "https://gw.alipayobjects.com/os/k/x5/intense.min.js",
        function () {
